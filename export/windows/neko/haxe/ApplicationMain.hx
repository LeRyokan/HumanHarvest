...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "HumanHarvest", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "HumanHarvest";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "HumanHarvest", null, { width: 1280, height: 860 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 1280, height: 860 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 1280, 860, "null");
		#end
		#else
		create ();
		#end
